...
const incident_validation_1 = __importDefault(require("./incident.validation"));
const incident_service_1 = __importDefault(require("./incident.service"));
class IncidentController {
    constructor() {
        this.path = '/';
        this.router = (0, express_1.Router)();
        this.IncidentService = new incident_service_1.default();
    ...
    initialiseRoutes() {
        this.router.post(`${this.path}`, (0, validation_middleware_1.default)(incident_validation_1.default.create), this.create);
        this.router.get(`${this.path}`, this.getIncidents);
        this.router.get(`${this.path}:incidentId`, this.getIncidentById);
        this.router.patch(`${this.path}status/:incidentId`, (0, validation_middleware_1.default)(incident_validation_1.default.updateStatus), this.updateStatus);
        this.router.patch(`${this.path}:incidentId`, (0, validation_middleware_1.default)(incident_validation_1.default.updateIncident), this.updateIncident);
